...
service "passenger" do
  ...
  reload_command "/etc/init.d/passenger reload"
  start_command "/etc/init.d/passenger start"
  stop_command "/etc/init.d/passenger stop"
  restart_command "/etc/init.d/passenger restart"
